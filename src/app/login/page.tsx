      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-8">
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-400">Continue your study journey</p>
          </div>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 bg-slate-900/50 border-slate-700/50 text-white placeholder:text-slate-500 focus:border-cyan-500 focus:ring-cyan-500/20 transition-all duration-300 hover:border-slate-600"
                  />
                </div>
              </div>
            ...
            <Button className="w-full bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-medium py-3 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg hover:shadow-cyan-500/25">
              Sign In
            </Button>
            ...
            <Button
              variant="outline"
              className="w-full border-slate-700/50 bg-slate-900/30 text-slate-300 hover:bg-slate-800/50 hover:border-slate-600 transition-all duration-300 transform hover:scale-[1.02]"
            >
